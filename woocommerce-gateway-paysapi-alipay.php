...
/**
 * Plugin Name: WooCommerce paysapi-支付宝
 * Plugin URI: https://paysapi.com/
 * Description: paysapi提供的支付宝支付
 * Version: 1.0.0
 * Author: paysapi.com
...
add_action('plugins_loaded', 'init_woocommerce_gateway_paysapi_alipay');

function init_woocommerce_gateway_paysapi_alipay()
{
    ...
    class Paysapi_WC_Payment_Gateway_Alipay extends WC_Payment_Gateway
    {
        public function __construct()
        {
            $this->id = 'paysapi_alipay';
    ...
    function add_gateway_paysapi_alipay_class($gateways)
    {
        $gateways[] = 'Paysapi_WC_Payment_Gateway_Alipay';
        return $gateways;
    }

    add_filter('woocommerce_payment_gateways', 'add_gateway_paysapi_alipay_class');
